...
1. Buka file `usb_fat_carving.001` kamu di HxD.
   ![Membuka file image di HxD](https://dikamaulidal.me/images/1-file-carving.png)
2. Tekan **Ctrl + F**, pilih tab **Hex-values**, masukkan kode: `FF D8 FF E0`.
   ![Input hex signature JPG di pencarian](https://dikamaulidal.me/images/2-file-carving.png)
3. Kalau ketemu, klik pada byte `FF` pertama dan catat angka **Offset**-nya (misal: `52000`). Ini adalah titik _Start_ file kita.
   ![Menemukan offset awal file](https://dikamaulidal.me/images/3-file-carving.png)
...
1. Masih di HxD, lakukan pencarian (**Ctrl + F**) untuk kode hex `FF D9`.
   ![Mencari trailer hex FF D9](https://dikamaulidal.me/images/4-file-carving.png)
...
![Melihat posisi offset trailer](https://dikamaulidal.me/images/5-file-carving.png)
...
3. **Penting:** Tambahkan 1 byte pada End Offset di kolom pencarian agar karakter terakhir (`D9`) ikut terbawa sepenuhnya.
   ![Dialog Select Block di HxD](https://dikamaulidal.me/images/6-file-carving.png)
4. Kalau data sudah terblok (berwarna biru), tekan **Copy (Ctrl + C)**.
   ![Menyalin blok hex yang dipilih](https://dikamaulidal.me/images/8-file-carving.png)
...
![Hasil foto yang berhasil di-recover](https://dikamaulidal.me/images/hasil-recover.png)
